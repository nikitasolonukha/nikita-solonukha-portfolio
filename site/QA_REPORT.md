...
| Публикация | GitHub Pages, Home / Work / About / Archive и 4 ключевых кейса на 390/1440 | Коммит `4c297bd` собран; 16 опубликованных views, ошибок 0 |
...
Локальные замеры загрузки — диагностика, а не публичные Core Web Vitals или точный замер 60 fps. Отчёты: `site/qa/all-cases.json`, `site/qa/links.json`, `site/qa/content-integrity.json`, `site/qa/performance.json`, `site/qa/motion-pass.json`, `site/qa/public-smoke.json`.
