...
Локальные замеры загрузки — диагностика, а не публичные Core Web Vitals. Отчёты: `site/qa/all-cases.json`, `site/qa/links.json`, `site/qa/content-integrity.json`, `site/qa/performance.json`.
