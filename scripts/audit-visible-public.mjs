...
const excluded = /не подтверж|не провер|не восстанов|недоступ|\blocal\b|локальн|\bdemo\b|демо\b|\bmock\b|\breplay\b|\bverified\b|\bunverified\b|\bPASS\b|\bSKIP\b|overflow|fixture|\b(?:1440|768|390)\b|исходник не найден/i;
let count = 0;
