...
09. **Автоматизированная рассылка в Telegram 24/7 — BLOCKED**
    - Источник: Desktop/РАБОТА/Приложения/скрипт рассылка; 12 файлов совпали с копией для заказчика
    - Следующий шаг / причина: Найдено реальное видео Telegram Desktop, но в нём видны личные чаты и DevTools, а основной экран долго остаётся в загрузке. Публиковать запись нельзя; нужен новый обезличенный capture реального Telegram-сценария. См. projects/telegram-schedule/case.md и TELEGRAM_VISUAL_AUDIT.md.
