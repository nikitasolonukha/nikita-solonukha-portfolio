...
Final portfolio art-direction pass. `MASTER_CASE_QUEUE.md` records evidence status; this ledger records current presentation work. Read this file first, then only the current case.
...
|---:|---|---|---|---|
| 01 | Shopify Store Builder | shopify-store-builder | READY | Retain existing verified media |
| 02 | Meta Ads Library Collector | meta-ads | READY | Retain existing verified media |
| 03 | KONTUR | protective-structures | READY | Technical feature uses real site screens; mobile cover and 390/1440 checked |
| 04 | MAGNUM | magnum | READY | Author-recorded formats and gallery featured; mobile cover and 390/1440 checked |
| 05 | Пифпаф | pifpaf | READY | Reels-first cover and link-to-analytics feature; 390/1440 checked |
...
| 34 | Университетские проекты | university-projects | BLOCKED | Use existing case.md; missing originals recorded in PORTFOLIO_CORRECTION_QUEUE.md |
| 35 | Внутренние продукты · NDA | legal-automation | PRIVATE/NDA | Keep sanitized; do not invent UI |
