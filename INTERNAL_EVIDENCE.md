...
PROOF: Актуальные показатели уточнены автором: 176 пользователей и 62 оплативших (62/176 ≈ 35,2%). Исходная выгрузка в текущем пакете не найдена. В репозитории ppbot также есть JSON с 125 рецептами и Canvas reader.
